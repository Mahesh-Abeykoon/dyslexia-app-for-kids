...
public class Hodiya3 extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hodiya3_screen);

        videoPlayer = MediaPlayer.create(this, R.raw.hodiya3);

...
public class WordsScreen extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.words_screen);

        videoPlayer = MediaPlayer.create(this, R.raw.words);
